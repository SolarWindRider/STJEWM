...
| G8/G16 ID probe re-run + G4/G8/G16 stress probes | in-progress | 1-CPU box; each probe ~30s/cell, 12 × ~7 envs × ~7 targets per suite = 588 cells. As of late-run: G8 ID probe 27/588, G16 ID probe 28/588, G16 stress probe 16/144, G4 + G8 stress probe just started. |
| G4/G8/G16 stress event-align (ρ on 4 stress envs) | partial | G16 stress-align done (48/48), G4 + G8 stress-align running. |
