...
\begin{longtable}{p{0.13\textwidth}p{0.05\textwidth}p{0.05\textwidth}p{0.05\textwidth}p{0.42\textwidth}p{0.21\textwidth}}
\toprule
...
\begin{longtable}{p{0.12\textwidth}p{0.04\textwidth}p{0.04\textwidth}p{0.04\textwidth}p{0.42\textwidth}p{0.26\textwidth}}
\toprule
\textbf{env} & \textbf{obs} & \textbf{act} & \textbf{goal} & \textbf{每维物理含义} & \textbf{样本观测（seed=0, 50 步）} \\
\midrule
\endhead
...
\texttt{humanoid\_CMU}   & 63 & 56 & 25 & \texttt{[root\_xyz, root\_quat(4), cmurange(56)]}：3D 高自由度人形（CMU mocap 标记）；56 维 cmurange 是 mocap 关节角度，56 维 action 控制 56 个 actuator & \texttt{[−0.0004, −0.0002, +0.9503, +0.7367, +0.6759, −0.0203, …, +0.2063, +0.0861, −0.1953, +0.1751]} \\
