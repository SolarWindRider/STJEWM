...
\normalsize v0.7.10b + v0.7.11 + v0.7.12 联合实验记录}
\author{研究团队}
\date{2026-07-15}
...
\begin{itemize}
    ...
    \item 提出了新的诊断指标 (div, resp, $\rho$)；
    \item 证明了 SNN 家族（不只 STJEWM）在 calibrated regime 上的共同优势；
    \item 在 1 个特定跨基准族任务 (PushT) 和 1 个合成任务 (Event-Window) 上显示了胜出。
\end{itemize}
