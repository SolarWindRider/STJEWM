#!/bin/bash
# Eval CubifAE on the 16-env standard suite + 4 stress envs (no training).
set -e
cd /home/lx/snn

PY=/home/lx/miniconda3/envs/snn/bin/python
RESULTS_DIR=/home/lx/snn/results
OUT_DIR=/home/lx/snn/results/aggregate/eval_v1_cubifae
LOG_DIR=/home/lx/snn/logs/eval_v1_cubifae_v2
