"""Franka kitchen closed-loop sim eval."""
import argparse
import json
import sys
...
def main():
    args = parse_args()
    print(f"[franka-closed-loop] ckpt={args.ckpt}", flush=True)
    ...
    state_dim, action_dim = m.nq, m.nu
    ...
    with open(out_path, "w") as f:
        json.dump({"env": "franka_kitchen", "ckpt": args.ckpt, "n_episodes": args.n_episodes, "ep_len": args.ep_len, "n_nan_eps": nan_eps,
