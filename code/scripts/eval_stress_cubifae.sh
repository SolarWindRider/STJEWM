#!/bin/bash
# Eval CubifAE on the 4 stress envs (no training).
set -e
cd /home/lx/snn

PY=/home/lx/miniconda3/envs/snn/bin/python
RESULTS_DIR=/home/lx/snn/results
OUT_DIR=/home/lx/snn/results/aggregate/eval_stress_cubifae
LOG_DIR=/home/lx/snn/logs/eval_stress_cubifae_v2
mkdir -p "$OUT_DIR" "$LOG_DIR"

# (env_name eval_arg data_path goal_offset)
declare -A ENVS=(
...
for env in "${!ENVS[@]}"; do
    ...
    ckpt="$RESULTS_DIR/$env/cubifae_baseline/final.pt"
    if [ ! -f "$ckpt" ]; then
