"""Robotiq gripper closed-loop sim eval."""
...
XML = "/home/lx/miniconda3/envs/snn/lib/python3.10/site-packages/ogbench/manipspace/descriptions/robotiq_2f85/2f85.xml"
...
def main():
    ...
    print(f"[robotiq-cl] state={m.nq} act={m.nu} params={sum(p.numel() for p in model.parameters())/1e6:.2f}M", flush=True)
    ...
    with open(out_path, "w") as f:
        json.dump({"env": "robotiq_gripper", "ckpt": args.ckpt, "n_episodes": args.n_episodes, "ep_len": args.ep_len, "n_nan_eps": nans,
