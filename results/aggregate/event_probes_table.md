...
|---|---|---|---|---|---|---|---|---|---|---|
| event_contact | 0.634 | 0.672 | 0.602 | 0.665 | 0.606 | 0.521 | 0.582 | 0.575 | 0.607 | 0.552 |
| event_future_k10 | 0.493 | 0.505 | 0.494 | 0.532 | 0.506 | 0.500 | 0.507 | 0.521 | 0.502 | 0.505 |
| event_future_k5 | 0.456 | 0.388 | 0.525 | 0.508 | 0.435 | 0.430 | 0.443 | 0.377 | 0.435 | 0.431 |
| event_high_motion | **0.720** | **0.763** | 0.590 | 0.677 | 0.602 | 0.441 | 0.514 | 0.616 | 0.498 | 0.443 |
| event_low_motion | 0.617 | 0.643 | 0.555 | 0.535 | 0.571 | 0.558 | 0.554 | 0.556 | 0.561 | 0.547 |
| event_persistent | 0.549 | **0.771** | 0.573 | 0.624 | 0.522 | 0.551 | 0.612 | 0.523 | 0.593 | 0.570 |
| event_vel_above_median | 0.618 | 0.645 | 0.557 | 0.604 | 0.505 | 0.510 | 0.516 | 0.521 | 0.516 | 0.522 |
...
| target | cubifae_baseline | gru_baseline | slt_lif_mpc_free | slt_lif_mpc_trace | stjewm_hidden_leak | stjewm_membrane_readout | stjewm_no_trace | stjewm_rate_only | stjewm_spike_only | stjewm_trace_only |
|---|---|---|---|---|---|---|---|---|---|---|
| event_contact | 0.514 | 0.484 | 0.522 | 0.497 | 0.492 | 0.477 | 0.510 | 0.560 | 0.516 | 0.510 |
| event_future_k10 | 0.606 | 0.605 | 0.484 | 0.518 | 0.533 | 0.536 | 0.509 | 0.542 | 0.505 | 0.557 |
| event_future_k5 | 0.471 | 0.421 | 0.482 | 0.523 | 0.451 | 0.464 | 0.442 | 0.517 | 0.490 | 0.478 |
| event_high_motion | 0.580 | 0.578 | 0.501 | 0.567 | 0.628 | 0.605 | 0.579 | 0.649 | 0.639 | 0.596 |
| event_low_motion | 0.485 | 0.447 | 0.503 | 0.452 | 0.534 | 0.553 | 0.538 | 0.527 | 0.529 | 0.524 |
| event_persistent | 0.554 | 0.547 | 0.509 | 0.552 | 0.621 | 0.583 | 0.603 | 0.612 | 0.581 | 0.609 |
| event_vel_above_median | 0.574 | 0.524 | 0.512 | 0.493 | 0.548 | 0.560 | 0.531 | 0.565 | 0.538 | 0.557 |
...
| event_contact | **0.874** | **0.896** | **0.792** | **0.872** | **0.834** | **0.836** | **0.769** | **0.837** | **0.767** | n/a |
| event_future_k10 | **0.848** | **0.833** | **0.778** | **0.851** | **0.729** | **0.780** | **0.738** | **0.735** | **0.735** | n/a |
| event_future_k5 | **0.887** | **0.916** | **0.764** | **0.792** | **0.831** | **0.832** | **0.787** | **0.833** | **0.785** | n/a |
| event_persistent | **0.803** | **0.870** | **0.715** | **0.764** | **0.711** | **0.785** | **0.716** | **0.712** | **0.717** | n/a |
...
| event_future_k10 | 0.457 | 0.371 | 0.491 | 0.485 | 0.494 | 0.462 | 0.495 | 0.508 | 0.501 | 0.490 |
| event_future_k5 | 0.346 | 0.400 | 0.485 | 0.422 | 0.432 | 0.397 | 0.500 | 0.412 | 0.399 | 0.413 |
| event_high_motion | 0.226 | 0.396 | 0.483 | 0.534 | 0.359 | 0.346 | 0.375 | 0.309 | 0.357 | 0.336 |
| event_low_motion | 0.305 | 0.321 | 0.441 | 0.419 | 0.272 | 0.273 | 0.258 | 0.266 | 0.290 | 0.263 |
| event_persistent | 0.219 | 0.402 | 0.537 | 0.374 | 0.311 | 0.351 | 0.292 | 0.411 | 0.392 | 0.499 |
| event_vel_above_median | 0.259 | 0.328 | 0.481 | 0.450 | 0.338 | 0.284 | 0.297 | 0.291 | 0.290 | 0.275 |
...
| slt_lif_mpc_free | 49 | 0.560 | 0.522 |
...
| ball_in_cup | event_future_k10 | slt_lif_mpc_trace | 0.532 | stjewm_rate_only | 0.521 |
| ball_in_cup | event_future_k5 | slt_lif_mpc_free | 0.525 | slt_lif_mpc_trace | 0.508 |
...
| finger | event_contact | stjewm_rate_only | 0.560 | slt_lif_mpc_free | 0.522 |
...
| walker | event_future_k10 | stjewm_rate_only | 0.508 | stjewm_spike_only | 0.501 |
| walker | event_future_k5 | stjewm_no_trace | 0.500 | slt_lif_mpc_free | 0.485 |
| walker | event_high_motion | slt_lif_mpc_trace | 0.534 | slt_lif_mpc_free | 0.483 |
| walker | event_low_motion | slt_lif_mpc_free | 0.441 | slt_lif_mpc_trace | 0.419 |
| walker | event_persistent | slt_lif_mpc_free | 0.537 | stjewm_trace_only | 0.499 |
| walker | event_vel_above_median | slt_lif_mpc_free | 0.481 | slt_lif_mpc_trace | 0.450 |
