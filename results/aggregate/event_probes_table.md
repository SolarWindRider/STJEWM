...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| event_contact | 0.625 | 0.553 | 0.568 | 0.562 | 0.555 | 0.595 | 0.535 | 0.634 | 0.633 | 0.603 | 0.629 | 0.628 |
| event_future_k5 | 0.604 | 0.573 | 0.535 | 0.491 | 0.556 | 0.586 | 0.500 | 0.595 | 0.591 | 0.588 | 0.593 | 0.593 |
| event_high_motion | 0.619 | 0.582 | 0.548 | 0.544 | 0.547 | 0.580 | 0.536 | 0.635 | 0.639 | 0.614 | 0.637 | 0.637 |

## Env: `cartpole_2d`

| target | cubifae_baseline | gru_baseline | lewm_baseline_v2 | mlp_baseline | slt_lif_mpc_free | slt_lif_mpc_trace | spikedreamer_baseline | stjewm_hidden_leak | stjewm_membrane_readout | stjewm_no_trace | stjewm_spike_only | stjewm_trace_only |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| event_contact | **0.758** | **0.781** | 0.612 | 0.519 | 0.477 | 0.432 | 0.654 | **0.710** | **0.712** | **0.745** | **0.715** | **0.704** |
| event_future_k5 | **0.798** | **0.755** | 0.642 | 0.587 | 0.573 | 0.634 | 0.604 | **0.773** | **0.770** | **0.784** | **0.775** | **0.767** |
| event_high_motion | **0.801** | **0.832** | 0.588 | 0.523 | 0.591 | 0.655 | 0.633 | **0.727** | **0.729** | **0.749** | **0.733** | **0.732** |

## Env: `cheetah`

| target | cubifae_baseline | gru_baseline | lewm_baseline_v2 | mlp_baseline | slt_lif_mpc_free | slt_lif_mpc_trace | spikedreamer_baseline | stjewm_hidden_leak | stjewm_membrane_readout | stjewm_no_trace | stjewm_spike_only | stjewm_trace_only |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| event_future_k10 | 0.540 | 0.562 | n/a | 0.547 | 0.522 | 0.528 | 0.507 | 0.530 | 0.532 | 0.530 | 0.519 | 0.530 |
| event_high_motion | 0.567 | 0.590 | n/a | 0.551 | 0.523 | 0.546 | 0.504 | 0.499 | 0.500 | 0.505 | 0.502 | 0.497 |
| event_low_motion | 0.517 | 0.524 | n/a | 0.536 | 0.495 | 0.505 | 0.481 | 0.501 | 0.503 | 0.493 | 0.497 | 0.507 |
...
| target | cubifae_baseline | gru_baseline | lewm_baseline_v2 | mlp_baseline | slt_lif_mpc_free | slt_lif_mpc_trace | spikedreamer_baseline | stjewm_hidden_leak | stjewm_membrane_readout | stjewm_no_trace | stjewm_spike_only | stjewm_trace_only |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| event_contact | 0.502 | 0.514 | n/a | 0.487 | 0.491 | 0.500 | 0.523 | 0.510 | 0.508 | 0.519 | 0.510 | 0.516 |
| event_future_k5 | 0.498 | 0.504 | n/a | 0.497 | 0.498 | 0.504 | 0.508 | 0.500 | 0.507 | 0.504 | n/a | 0.509 |
| event_high_motion | 0.502 | 0.512 | n/a | 0.511 | 0.494 | 0.499 | 0.502 | 0.511 | 0.510 | 0.506 | 0.513 | 0.515 |
...
| event_contact | **0.940** | **0.978** | n/a | **0.967** | **0.795** | **0.887** | 0.615 | **0.936** | **0.936** | **0.863** | **0.936** | **0.936** |
| event_future_k10 | **0.904** | **0.970** | n/a | **0.936** | **0.777** | **0.861** | 0.589 | **0.881** | **0.881** | **0.836** | **0.882** | **0.881** |

## Env: `tworoom`

| target | cubifae_baseline | gru_baseline | lewm_baseline_v2 | mlp_baseline | slt_lif_mpc_free | slt_lif_mpc_trace | spikedreamer_baseline | stjewm_hidden_leak | stjewm_membrane_readout | stjewm_no_trace | stjewm_spike_only | stjewm_trace_only |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| event_future_k5 | 0.500 | 0.521 | n/a | 0.510 | 0.497 | 0.488 | 0.500 | 0.493 | 0.496 | 0.521 | 0.491 | 0.488 |
| event_high_motion | 0.491 | 0.513 | n/a | 0.491 | 0.491 | 0.487 | 0.499 | 0.492 | 0.493 | 0.523 | 0.492 | 0.492 |
| event_room_entered | **0.772** | **0.791** | n/a | **0.755** | 0.606 | 0.690 | 0.568 | **0.708** | **0.706** | **0.715** | **0.706** | **0.704** |
...
|---|---|---|---|
| cubifae_baseline | 18 | 0.663 | 0.611 |
| gru_baseline | 18 | 0.670 | 0.578 |
| lewm_baseline_v2 | 6 | 0.582 | 0.578 |
| mlp_baseline | 18 | 0.612 | 0.540 |
| slt_lif_mpc_free | 18 | 0.581 | 0.535 |
| slt_lif_mpc_trace | 18 | 0.610 | 0.563 |
| spikedreamer_baseline | 18 | 0.554 | 0.529 |
...
| ball_in_cup | event_future_k5 | cubifae_baseline | 0.604 | stjewm_hidden_leak | 0.595 |
| ball_in_cup | event_high_motion | stjewm_membrane_readout | 0.639 | stjewm_trace_only | 0.637 |
| cartpole_2d | event_contact | gru_baseline | 0.781 | cubifae_baseline | 0.758 |
| cartpole_2d | event_future_k5 | cubifae_baseline | 0.798 | stjewm_no_trace | 0.784 |
| cartpole_2d | event_high_motion | gru_baseline | 0.832 | cubifae_baseline | 0.801 |
| cheetah | event_future_k10 | gru_baseline | 0.562 | mlp_baseline | 0.547 |
| cheetah | event_high_motion | gru_baseline | 0.590 | cubifae_baseline | 0.567 |
...
| finger | event_future_k5 | stjewm_trace_only | 0.509 | spikedreamer_baseline | 0.508 |
...
| tworoom | event_high_motion | stjewm_no_trace | 0.523 | gru_baseline | 0.513 |
| tworoom | event_room_entered | gru_baseline | 0.791 | cubifae_baseline | 0.772 |
