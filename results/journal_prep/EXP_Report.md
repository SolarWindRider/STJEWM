...
### 8.2 结果(cross_benchmark_F1,15 env-cells)

| λ | cos | env-SR | LeWM-SR |
|---|---:|---:|---:|
| 0.09 | 0.2520 | 0.33 | 0.37 |
| 0.01 | (补跑中) | — | — |
| 0.001 | (补跑中) | — | — |
| 0.0 | (补跑中) | — | — |

(oodc_F2 6 cells 同步补跑中;落盘后本表自动可补)

### 8.3 说明了什么
λ=0.09 基线与旧代际同配置一致;λ→0 的塌缩行为是"sigreg 防塌必要性"的直接证据(补跑数据落盘后回填)。
