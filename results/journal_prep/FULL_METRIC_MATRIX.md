...
按 `cos` 列从低到高：
- **坍缩簇**（cos ≈ 0）：MLP 0.007, GRU 0.020, LIFTransformer 0.000 —— 常数潜变量，
  任何目标都「命中」（LeWM@.05 0.89–1.00 是假阳性）。
- **校准簇**（cos 0.10–0.12）：STJEWM 6 变体 + Stacked-LIF×2 + ALIF-timecell —— 潜变量与目标成比例，
...
| ALIF-timecell | 89 | 0.105 | 0.422 | 0.366 | 0.9988 | 0.502 | 9.686 | 9.96 | 100.0 | 4.98 | 0.124±0.007 | -0.002 | 0.004 | -0.038 |
| Stacked-LIF-trace | 93 | 0.106 | 0.366 | 0.346 | 0.9996 | 0.672 | 2.125 | 10.18 | 99.1 | 5.11 | 0.115±0.004 | -0.001 | -0.008 | -0.068 |
| Stacked-LIF-free | 90 | 0.111 | 0.376 | 0.342 | 0.9997 | 0.587 | 1.940 | 10.07 | 99.2 | 5.05 | 0.122±0.006 | 0.063 | 0.099 | -0.010 |
...
| LIFTransformer | 89 | 0.000 | 1.000 | 0.375 | -0.0003 | 0.543 | 9.573 | 10.07 | 99.8 | 5.12 | -0.000±0.000 | -0.037 | -0.023 | -0.095 |
...
- **event-ρ**: STJEWM 6 + Stacked-LIF 2 + ALIF-timecell ≥ 0.9986 (spike-based); LeWM 0.75; GRU -0.007; MLP -0.023; LIFTransformer -0.0003.
- **AUROC** (1-epoch): Stacked-LIF-trace 0.672 best, LeWM 0.626, STJEWM ≈ 0.50 chance; LeWM recovers 0.63 at 3-epoch (P13).
