...
| ALIF-timecell | 0.9970 | 1.0000 | 0.9985 | 0.9998 | 0.9988 |
| Stacked-LIF-trace | 0.9996 | 1.0000 | 0.9987 | 1.0000 | 0.9996 |
| Stacked-LIF-free | 0.9988 | 1.0000 | 1.0000 | 1.0000 | 0.9997 |
| LeWM-v2 | 0.7934 | 0.2600 | 0.9672 | 0.9855 | 0.7515 |
| GRU | -0.1111 | 0.0027 | -0.0317 | 0.1106 | -0.0074 |
| MLP | -0.0220 | -0.0556 | 0.0015 | -0.0170 | -0.0233 |
| LIFTransformer | -0.0312 | 0.0102 | -0.0298 | 0.0497 | -0.0003 |

## Verdict

**No, the claim does not hold as stated under complete coverage.** All six STJEWM readouts and both Stacked-LIF variants exceed $\rho=0.9$ (means 0.9986–0.9997), but the nominal non-SNN ALIF-timecell baseline also has $\rho=0.9988$, violating the “non-SNN < 0.8” clause. LeWM-v2 (0.7515), GRU (-0.0074), and MLP (-0.0233) are below 0.8. LIFTransformer is an SNN/Transformer hybrid, not a non-SNN baseline, and has mean $\rho=-0.0003$. Thus the complete results support strong alignment for STJEWM and Stacked-LIF, but not a clean SNN-family-versus-non-SNN separation.
